package com.roufsyed.onekey.lint
 ...
 * `LockAware*` wrappers in [com.roufsyed.onekey.core.presentation.lockaware] inject a
...
class UnsafeUnlockableSurfaceDetector : Detector(), SourceCodeScanner {
    ...
    companion object {
        const val LOCKAWARE_PACKAGE = "com.roufsyed.onekey.core.presentation.lockaware"
