package com.roufsyed.onekey.feature.secretkey.pdf

import android.app.Application
import com.roufsyed.onekey.feature.secretkey.scan.SECRET_KEY_HUMAN_PREFIX
import com.roufsyed.onekey.feature.secretkey.scan.SECRET_KEY_QR_VERSION
...
class EmergencyKitPdfGeneratorTest {
    ...
    private fun locateProductionSource(): File? {
        val candidates = listOf(
            "src/main/java/com/roufsyed.onekey/feature/secretkey/pdf/EmergencyKitPdfGenerator.kt",
            "app/src/main/java/com/roufsyed.onekey/feature/secretkey/pdf/EmergencyKitPdfGenerator.kt",
            "../app/src/main/java/com/roufsyed.onekey/feature/secretkey/pdf/EmergencyKitPdfGenerator.kt",
        )
