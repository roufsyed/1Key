 ...
 * `consume()` returns an empty `CharArray` because [com.onekey.core.presentation
...
class ImportExportViewModelExportPasswordTest {
    ...
    /**
     * Mirrors the real [com.onekey.core.data.repository.AuthRepositoryImpl.unlockWithPassword]
