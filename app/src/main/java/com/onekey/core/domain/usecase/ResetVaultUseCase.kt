...
class ResetVaultUseCase @Inject constructor(
     ...
     *
     * Why lock-first: [com.onekey.core.security.VaultKeyHolder.lock] now
     * synchronously fires the [com.onekey.core.security.VaultLockHook]
     * installed by [com.onekey.core.data.snapshot.VaultSnapshotStore]. That
