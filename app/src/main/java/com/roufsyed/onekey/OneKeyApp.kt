...
import com.roufsyed.onekey.core.data.snapshot.VaultSnapshotStore
...
import com.roufsyed.onekey.core.security.CredentialCipherMigrator
import com.roufsyed.onekey.core.security.ScreenOffLockReceiver
...
class OneKeyApp : Application() {
     ...
     * installs the synchronous `VaultLockHook` on [com.roufsyed.onekey.core.security.VaultKeyHolder].
