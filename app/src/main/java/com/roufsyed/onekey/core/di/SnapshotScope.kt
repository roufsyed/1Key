 ...
 * lifetime of [com.roufsyed.onekey.core.data.snapshot.VaultSnapshotStore]'s
...
/**
 * Qualifier for the `StateFlow<com.roufsyed.onekey.core.data.snapshot.SnapshotState>`
 * re-published from [com.roufsyed.onekey.core.data.snapshot.VaultSnapshotStore.state].
 *
