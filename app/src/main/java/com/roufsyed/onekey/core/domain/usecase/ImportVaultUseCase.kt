...
import com.roufsyed.onekey.feature.importexport.domain.ConflictPair
...
import com.roufsyed.onekey.feature.importexport.domain.MergePair
...
import com.roufsyed.onekey.feature.importexport.domain.SkippedCredential
...
class ImportVaultUseCase @Inject constructor(
     ...
     *
     * Used by [com.roufsyed.onekey.feature.importexport.presentation.viewmodel.ImportExportViewModel]
     * for the in-vault import flow (Settings > Backup & Import > Import). The
     * onboarding restore-from-backup flow calls
     * [com.roufsyed.onekey.feature.importexport.domain.VaultImporter.parseEncrypted]
