...
/**
 * Why was the vault locked? Set by callers immediately before [com.roufsyed.onekey.core.domain.repository.AuthRepository.lock]
 * so the [LockScreen][com.roufsyed.onekey.feature.auth.presentation.screen.LockScreen] can show a one-shot
 ...
 *
 * Cleared by [com.roufsyed.onekey.feature.auth.presentation.viewmodel.AuthViewModel.unlockWithPassword]
