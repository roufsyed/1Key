 ...
 * lands; the post-rotate flow navigates to [com.roufsyed.onekey.feature.settings.presentation.screen.EmergencyKitSavePromptScreen]
 ...
 *    [com.roufsyed.onekey.feature.settings.presentation.screen.SettingsSecurityScreen].
 *
 * Caller contract:
