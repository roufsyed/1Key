...
import com.roufsyed.onekey.feature.auth.presentation.dialog.MasterPasswordReauthDialog
import com.roufsyed.onekey.feature.auth.presentation.dialog.MasterPasswordReauthState
import com.roufsyed.onekey.feature.settings.presentation.dialog.KdfCustomDialog
import com.roufsyed.onekey.feature.settings.presentation.viewmodel.SettingsEvent
import com.roufsyed.onekey.feature.settings.presentation.viewmodel.SettingsViewModel
...
fun SettingsKdfStrengthScreen(
    ...
    if (showCustomDialog) {
        ...
        val activeMt = com.roufsyed.onekey.core.security.currentActiveMt(activePreset, activeCustomParams)
        ...
        KdfCustomDialog(
            ...
            initialM = seedM,
            initialT = seedT,
            currentActiveMt = com.roufsyed.onekey.core.security.currentActiveMt(activePreset, activeCustomParams),
            isBenchmarking = isBenchmarking,
            estimate = { params ->
...
private fun KdfStrengthContent(
    ...
    capacity: com.roufsyed.onekey.core.security.CapacitySnapshot,
