 ...
 *  - Launched by [com.roufsyed.onekey.feature.autofill.service.OneKeyAutofillService]
 *    with `FLAG_ACTIVITY_NEW_TASK` and a single opaque token extra. The
 *    plaintext payload lives in [com.roufsyed.onekey.feature.autofill.domain.AutofillCaptureBuffer]
...
class AutofillSaveActivity : FragmentActivity() {
    ...
    companion object {
        const val EXTRA_TOKEN = "com.roufsyed.onekey.autofill.SAVE_TOKEN"
    }
