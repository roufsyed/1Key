...
import com.roufsyed.onekey.core.security.PinAttemptTracker.Companion.lockoutDurationMs
...
import com.roufsyed.onekey.feature.secretkey.scan.canonicalSkToBytes
...
class AuthViewModel @Inject constructor(
    ...
    private val credentialRepository: com.roufsyed.onekey.core.domain.repository.CredentialRepository,
) : ViewModel() {
    ...
    fun ensurePendingSecretKey() {
        ...
        _pendingSecretKeyCanonical.value =
            com.roufsyed.onekey.feature.secretkey.scan.formatCanonicalSkForPrint(
                com.roufsyed.onekey.feature.secretkey.scan.bytesToCanonicalSk(raw),
            )
    }
