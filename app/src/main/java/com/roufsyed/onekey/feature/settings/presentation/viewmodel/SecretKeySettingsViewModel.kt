...
import com.roufsyed.onekey.core.security.HardwareKeyIsolationTier
import com.roufsyed.onekey.core.security.KEYSTORE_ALIAS_SECRET_KEY_PREFIX
...
import com.roufsyed.onekey.feature.secretkey.domain.SecretKeyDisableUseCase
import com.roufsyed.onekey.feature.secretkey.domain.SecretKeyEnableUseCase
import com.roufsyed.onekey.feature.secretkey.domain.SecretKeyRotateUseCase
import com.roufsyed.onekey.feature.secretkey.pdf.EmergencyKitPdfGenerator
import com.roufsyed.onekey.feature.secretkey.scan.bytesToCanonicalSk
...
/**
 * Top-level state surface emitted to [com.roufsyed.onekey.feature.settings.presentation.screen.SettingsSecretKeyScreen].
...
class SecretKeySettingsViewModel @Inject constructor(
     ...
     * [com.roufsyed.onekey.feature.auth.presentation.viewmodel.AuthViewModel.notifyPickerLaunched]
     ...
     * navigate to [com.roufsyed.onekey.feature.settings.presentation.screen.EmergencyKitSavePromptScreen].
     *
     ...
     * (the migrator's [com.roufsyed.onekey.core.security.KdfMigrator.runSecretKeyTransition]
