...
interface VaultExporter {
     ...
     * encryption pipeline ([com.roufsyed.onekey.feature.importexport.domain.BackupEncryption.encryptWithKey])
...
data class EncryptedExportContext(
    val kdfParams: com.roufsyed.onekey.core.security.KdfParams,
...
interface VaultImporter {
     ...
     * to also call [com.roufsyed.onekey.core.domain.repository.AuthRepository.setupMasterPassword]
